export const translations = {
  ...
  es: {
    ...
    'role.starter': 'Inicio',
    'role.work': 'Desarrollo',
    'role.secure': 'Cierre',
    'role.homework': 'Tarea',
    'role.solution': 'Solución',
    'role.exam': 'Prueba',
    'role.other': 'Otros',
    'roles.grouped': 'Clase',
    'roles.bulk_assign': 'Asignar rol…',
    'teach.open': 'Mostrar clase',
    'teach.mode': 'Modo clase',
    'teach.show_solutions': 'Mostrar soluciones',
    'teach.hide_solutions': 'Ocultar soluciones',
    'teach.empty': 'No hay material para esta clase.',
    'versions.edit_copy': 'Editar copia',
    'versions.copy_opening': 'Abriendo copia…',
    'versions.copy_opened': 'Copia abierta',
    'versions.copy_error': 'Error al abrir copia',
    'versions.commit': 'Guardar nueva versión',
    'versions.saving': 'Guardando versión…',
    'versions.saved': 'Versión guardada',
    'versions.save_error': 'No hay copia de trabajo',
    'versions.count': 'versiones',
    'toast.role_saved': 'Rol de material guardado.',
    'toast.role_error': 'No se pudo guardar el rol.',
    'toast.version_saved': 'Nueva versión guardada.',
  ...
  en: {
    ...
    'role.work': 'Work phase',
    'role.secure': 'Consolidation',
    'role.homework': 'Homework',
    'role.solution': 'Solution',
    'role.exam': 'Exam',
    'role.other': 'Other',
    'roles.grouped': 'Lesson',
    'roles.bulk_assign': 'Assign role…',
    'teach.open': 'Show lesson',
    'teach.mode': 'Lesson mode',
    'teach.show_solutions': 'Show solutions',
    'teach.hide_solutions': 'Hide solutions',
    'teach.empty': 'No material for this lesson.',
    'versions.edit_copy': 'Edit copy',
    'versions.copy_opening': 'Opening copy…',
    'versions.copy_opened': 'Copy opened',
    'versions.copy_error': 'Could not open copy',
    'versions.commit': 'Save new version',
    'versions.saving': 'Saving version…',
    'versions.saved': 'Version saved',
    'versions.save_error': 'No working copy found',
    'versions.count': 'versions',
    'toast.role_saved': 'Material role saved.',
    'toast.role_error': 'Could not save material role.',
    'toast.version_saved': 'New version saved.',
